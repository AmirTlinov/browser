...
class BrowserConfig:
    ...
    def from_env(cls) -> BrowserConfig:
        profile = expand_path(os.environ.get("MCP_BROWSER_PROFILE", "~/.gemini/antigravity-browser-profile"))
    ...
    def is_host_allowed(self, host: str) -> bool:
        ...
        if not self.allow_hosts:
            return True
        return any(host.endswith(allowed) or host == allowed for allowed in self.allow_hosts)
