...
```bash
# Демонстрация запускает браузер в видимом режиме
...
```bash
# Headless режим (быстрее, дефолт для сервера)
...
- Используйте видимый режим (`MCP_HEADLESS=0`)
