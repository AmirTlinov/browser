...
def test_run_default_report_is_map_in_v2(monkeypatch: pytest.MonkeyPatch) -> None:
    """In MCP_TOOLSET=v2, run() should default report=map when report is omitted."""
    ...
    map_payload = {
        "map": {"page": {"url": "about:blank"}, "summary": {"jsErrors": 0}, "actions": {"items": []}},
        "cursor": 1_000_000,
        "duration_ms": 1,
        "sessionTabId": "tab1",
        "target": "tab1",
    ...
    res = handler(
        ...
        args={
            ...
            # report is intentionally omitted
            "auto_recover": False,
            "action_timeout": 0.5,
        },
    )
